    ...
    "gs2m": {
        ...
        "mesh_params": [
            ...
            {"key": "auto_voxel", "flag": "--auto_voxel", "type": "bool", "default": True,
             "label": "自動體素大小（推薦）",
             "hint": "從高斯點雲密度自動估 voxel_size（作者推薦）。需要 scipy;不可用時會自動 fallback 到啟發式。"},
            {"key": "voxel_size", "flag": "--voxel_size", "type": "float", "default": "",
             "label": "體素大小 voxel_size",
             "hint": "TSDF 取樣格大小。越小 → 越密越細，但越慢、越吃記憶體。留空 = 自動;手動填數值會覆蓋自動估計。"},
            {"key": "sdf_trunc", "flag": "--sdf_trunc", "type": "float", "default": "",
             "label": "SDF 截斷 sdf_trunc",
             "hint": "越小 → 表面越銳利但對深度雜訊越敏感;越大 → 越穩但細節變糊。留空 = 自動（4 × voxel_size）。"},
